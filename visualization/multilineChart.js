...
d3.json("../dataset/players_data.json").then(function (data) {
  ...
  let margin = { top: 70, right: 80, bottom: 35, left: 50 };
  ...
  svg
    .append("defs")
    .append("clipPath") // define un clipPath dentro de 'defs'
  ...
  // agregar el eje Y
  svg.append("g").attr("class", "eje-y").call(d3.axisLeft(y));

  const tituloGrafico = svg
    .append("text")
    .attr("id", "titulo-grafico-multi")
    .attr("x", width / 2)
    .attr("y", -margin.top / 2)
    .attr("text-anchor", "middle")
    .style("font-size", "24px")
    .text("Los 10 mayores anotadores de la historia de la NBA")
